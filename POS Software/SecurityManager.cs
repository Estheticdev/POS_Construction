        ...
        public static string EncryptAndSaveFile(Stream inputFilename, string filePath)
        {
            try
            {
                using (inputFilename)
                {
                    ...
                    string configVector = Convert.ToString(System.Configuration.ConfigurationSettings.AppSettings["vect64bit"]);
                    string configKey = Convert.ToString(System.Configuration.ConfigurationSettings.AppSettings["key128bit"]);
