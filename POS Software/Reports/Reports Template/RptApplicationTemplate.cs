...
{
    public partial class RptApplicationTemplate : DevExpress.XtraReports.UI.XtraReport
    {
        public RptApplicationTemplate()
        {
            InitializeComponent();
        }

        public RptApplicationTemplate(XtraReport xr, DataTable dt)
        {
            InitializeComponent();
            Tag = xr.Tag;
