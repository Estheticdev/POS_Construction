...
{
    public partial class RptSalesInvoice_A4_English : DevExpress.XtraReports.UI.XtraReport
    {
        public RptSalesInvoice_A4_English()
        {
            InitializeComponent();
      ...
      //  List<CurrencyInfo> currencies = new List<CurrencyInfo>();
        ...
        private void xrcc1_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
                ...
                xrcc1.Visible = (bool)Modules.General.dtsetting.Rows[8]["Setting_Value"];
            xrcc2.Visible = (bool)Modules.General.dtsetting.Rows[9]["Setting_Value"];
            xrlocation.Visible = (bool)Modules.General.dtsetting.Rows[10]["Setting_Value"];
