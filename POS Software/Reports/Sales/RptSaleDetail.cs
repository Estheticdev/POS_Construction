...
{
    public partial class RptSaleDetail : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        private void TblHdrCelNo_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            TblHdrCelCustomerType.Text = "اسم العميل";
        ...
        {
            lblReportName.Text = "تفاصيل فاتورة البيع";
        }

        private void LblPrintDate_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            LblPrintDate.Format = string.Format("Date:{0}", Modules.Main.DateFormat2);
        }
