...
{
    public partial class RptStockInDetail : DevExpress.XtraReports.UI.XtraReport
    {
        public RptStockInDetail()
        {
            InitializeComponent();
        }
        ...
        private void TblHdrCelNo_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            TblHdrCelTotalStock.Text = "Stock In";
            xlblRemarks.Text = "Remarks";
